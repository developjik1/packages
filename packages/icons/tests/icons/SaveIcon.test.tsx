...
import { SaveIcon } from '../../src/index';

describe('SaveIcon', () => {
  it('렌더링되어야 한다', () => {
    render(<SaveIcon data-testid="saveicon" />);
    const icon = screen.getByTestId('saveicon');
  ...
  it('커스텀 props를 전달받을 수 있어야 한다', () => {
    const { container } = render(<SaveIcon width={32} height={32} />);
    const svgElement = container.querySelector('svg');
