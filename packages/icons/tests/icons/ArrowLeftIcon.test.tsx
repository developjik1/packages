...
import { ArrowLeftIcon } from '../../src/index';

describe('ArrowLeftIcon', () => {
  it('렌더링되어야 한다', () => {
    render(<ArrowLeftIcon data-testid="arrowlefticon" />);
    const icon = screen.getByTestId('arrowlefticon');
  ...
  it('커스텀 props를 전달받을 수 있어야 한다', () => {
    const { container } = render(<ArrowLeftIcon width={32} height={32} />);
    const svgElement = container.querySelector('svg');
