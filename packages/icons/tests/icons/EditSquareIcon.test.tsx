...
import { EditSquareIcon } from '../../src/index';

describe('EditSquareIcon', () => {
  it('렌더링되어야 한다', () => {
    render(<EditSquareIcon data-testid="editsquareicon" />);
    const icon = screen.getByTestId('editsquareicon');
  ...
  it('커스텀 props를 전달받을 수 있어야 한다', () => {
    const { container } = render(<EditSquareIcon width={32} height={32} />);
    const svgElement = container.querySelector('svg');
