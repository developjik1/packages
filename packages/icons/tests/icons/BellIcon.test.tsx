...
import { BellIcon } from '../../src/index';

describe('BellIcon', () => {
  it('렌더링되어야 한다', () => {
    render(<BellIcon data-testid="bellicon" />);
    const icon = screen.getByTestId('bellicon');
  ...
  it('커스텀 props를 전달받을 수 있어야 한다', () => {
    const { container } = render(<BellIcon width={32} height={32} />);
    const svgElement = container.querySelector('svg');
